...
This skill provides a structured framework for assessing design system coverage, consistency, and adoption quality. It encodes practical decision criteria, standard review checkpoints, and output conventions so teams can execute consistently across different AI agents and operators. The goal is to produce an actionable artifact that can be reused in downstream planning and execution.
...
{
  "design_system_audit": {
    "artifact_type": "design_system_audit",
