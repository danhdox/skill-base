...
This skill provides a structured framework for ranking feature candidates using a transparent RICE-based scoring model. It encodes practical decision criteria, standard review checkpoints, and output conventions so teams can execute consistently across different AI agents and operators. The goal is to produce an actionable artifact that can be reused in downstream planning and execution.
...
```json
{
  "feature_prioritization_rice": {
    "artifact_type": "prioritization_board",
