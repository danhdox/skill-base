...
This skill provides a structured framework for evaluating governance structure, voting mechanics, and operational resilience for blockchain protocols. It encodes practical decision criteria, standard review checkpoints, and output conventions so teams can execute consistently across different AI agents and operators. The goal is to produce an actionable artifact that can be reused in downstream planning and execution.
...
```json
{
  "protocol_governance_design_review": {
    "artifact_type": "governance_design_report",
